...
window.REY_JEUX = [
  ...
  },
  {
    ...
    persos: ["Kafka", "Acheron", "Firefly", "Robin", "Ruan Mei", "Sparkle", "Jingliu", "Dan Heng • Imbibitor Lunae", "Seele", "Silver Wolf", "Black Swan", "Huohuo", "Fu Xuan", "Aventurine", "Boothill", "Feixiao", "Lingsha", "Rappa"]
  },
  {
    slug: "wuwa",
    nom: "Wuthering Waves",
    ...
    persos: ["Jiyan", "Changli", "Camellya", "Carlotta", "Jinhsi", "Yinlin", "Verina", "Shorekeeper", "Xiangli Yao", "Zhezhi", "Calcharo", "Encore", "Rover", "Roccia", "Phoebe"]
  },
  {
    slug: "nte",
...
window.REY_DEMO = (function () {
  ...
  const builds = [
    ...
    { id: "b2", author_id: "u3", game: "hsr", character: "Acheron", title: "Acheron hypercarry", fields: { cone: "Son cône signature", reliques: "Set Foudre 4p", ornements: "Set ornement CRIT", stats: "DGT CRIT / ATQ% / Bonus DGT Foudre / ATQ%", traces: "6 / 10 / 10 / 10", eidolon: "E0", equipe: "Pela, Silver Wolf, Aventurine" }, notes: "Deux débuffeurs pour lancer l'ultime au bon moment.", created_at: j(1), likes: ["u1"], statut: "approuve", images: [capture("Acheron", "#c9a2ff")] },
    ...
    { id: "b5", author_id: "u1", game: "nte", character: "—", title: "Premier build NTE (à compléter)", fields: { arme: "", equipement: "", stats: "", competences: "", equipe: "" }, notes: "On définit ensemble le vocabulaire du jeu sur Discord.", created_at: j(0.3), likes: [], statut: "approuve", images: [capture("NTE", "#ff9a86")] }
  ];
  const evenements = [
